...
##################################################################################
TRAINING_INT_COLUMNS=['DEP_DOW', 'DEP_HOD']
...
TRAINING_COLUMNS=TRAINING_INT_COLUMNS+TRAINING_FLOAT_COLUMNS

TRAINING_SCHEMA={}
for t, cols in [(tf.float32, TRAINING_FLOAT_COLUMNS), (tf.int64, TRAINING_INT_COLUMNS)]:
